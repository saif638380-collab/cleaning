      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 tracking-tight leading-tight mb-6 text-center md:text-left">
              Why <span className="text-emerald-600">Ecoverde</span> Cleaning?
            </h2>

            <div className="space-y-4 font-sans text-slate-600 text-sm sm:text-base leading-relaxed text-center md:text-left max-w-3xl mb-10">
              <p>
            ...
            <div className="border-t border-slate-100 pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <button
                onClick={onBookClick}
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3.5 rounded-full font-sans text-sm font-semibold shadow-sm hover:shadow transition-all duration-200 shrink-0 whitespace-nowrap cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="rounded-2xl md:rounded-3xl overflow-hidden shadow-lg border border-slate-100 max-h-[300px]">
              <img
                src={cleanBathroom}
            ...
            <div className="space-y-4">
              {highlights.map((hl, idx) => (
                <div key={idx} className="flex gap-4 p-4 rounded-xl border border-slate-50 bg-slate-50/30 hover:bg-emerald-50/10 hover:border-emerald-100/50 transition-all duration-300">
